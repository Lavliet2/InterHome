...
**Включение режима разработчика (iOS 16+):**
- Перейдите: **Настройки → Конфиденциальность и безопасность**
- Найдите раздел **Режим разработчика** в самом низу списка
- Активируйте опцию и согласитесь на перезагрузку устройства
- После перезагрузки еще раз согласитесь на включение режима и повторно введите код разблокировки
